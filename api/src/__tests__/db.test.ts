...
describe('Database Module', () => {
  ...
  describe('addGeminiHistoryEntries', () => {
    it('should batch add entries', async () => {
      const entries = [
        { id: 'entry-1', url: 'http://example.com', promptPreview: 'test', status: 'success' as const, timestamp: '2024-01-01' },
        { id: 'entry-2', url: 'http://example.com/2', promptPreview: 'test2', status: 'error' as const, timestamp: '2024-01-02' },
      ];
