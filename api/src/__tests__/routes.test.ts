...
describe('API Routes', () => {
  ...
  describe('Add Gemini History', () => {
    it('should add history entries as array', async () => {
      const entries = [
        { id: 'entry-1', url: 'http://example.com', promptPreview: 'test', status: 'success', timestamp: '2024-01-01' },
      ];
    ...
    it('should add single history entry', async () => {
      const entry = { id: 'entry-1', url: 'http://example.com', promptPreview: 'test', status: 'success', timestamp: '2024-01-01' };
      mockAddGeminiHistoryEntries.mockResolvedValue(undefined);
