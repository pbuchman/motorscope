  ...
  describe('saveRefreshStatus', () => {
    ...
    it('should handle full status object', async () => {
      ...
      const fullStatus: RefreshStatus = {
        ...
        recentlyRefreshed: [
          { id: 'id1', title: 'Mercedes C200', url: 'https://example.com/3', status: 'success', timestamp: '2024-12-09T09:00:00Z' },
          { id: 'id2', title: 'VW Golf', url: 'https://example.com/4', status: 'success', timestamp: '2024-12-09T09:01:00Z' },
          { id: 'id3', title: 'Ford Focus', url: 'https://example.com/5', status: 'error', timestamp: '2024-12-09T09:02:00Z', error: 'Network error' },
        ],
        refreshErrors: [
          { id: 'err1', title: 'Ford Focus', url: 'https://example.com/5', error: 'Network error', timestamp: '2024-12-09T09:02:00Z' },
        ],
      };
  ...
  describe('updateRefreshStatus', () => {
    ...
    it('should preserve fields not included in update', async () => {
      const existingStatus: RefreshStatus = {
        ...
        lastRefreshTime: '2024-12-09T08:00:00Z',
        recentlyRefreshed: [
          { id: 'id1', title: 'BMW 320d', url: 'https://example.com/1', status: 'success', timestamp: '2024-12-09T08:00:00Z' },
          { id: 'id2', title: 'Audi A4', url: 'https://example.com/2', status: 'success', timestamp: '2024-12-09T08:01:00Z' },
        ],
      };
      mockGetWithDefault.mockResolvedValue(existingStatus);
      mockSetStorage.mockResolvedValue(undefined);
    ...
    it('should allow updating arrays', async () => {
      ...
      const newErrors = [
        { id: 'err1', title: 'BMW 320d', url: 'https://example.com/1', error: 'Network error', timestamp: '2024-12-09T10:00:00Z' },
        { id: 'err2', title: 'Audi A4', url: 'https://example.com/2', error: 'Rate limited', timestamp: '2024-12-09T10:01:00Z' },
      ];
