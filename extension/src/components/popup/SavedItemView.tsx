    ...
    <div className="w-full">
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 text-left mb-4">
        ...
        <div className="relative mb-2">
          ...
          <div className="absolute top-2 left-2 bg-green-500/90 backdrop-blur-sm text-white px-2 py-1 rounded-md flex items-center gap-1.5 shadow-sm">
        ...
        {listing.vehicle?.vin && (
          <div className="bg-green-50 border border-green-200 rounded px-2 py-0.5 mb-2">
            <span className="text-[10px] text-green-700 font-mono">{t('common:vehicle.vin')}: {listing.vehicle.vin}</span>
          </div>
        )}
